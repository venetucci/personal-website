...
This work situates Silicon Valley within a broader story of the post-1970s financialization of the U.S. economy, as people gravitate towards venture-backed companies as one of the few remaining pathways for maintaining middle class lifestyles. Following feminist anthropologists who reject the separation of "the economic" from domestic and social life, I examine the suburban family practices of the tech workforce not as background context but as a key site where inequality is legitimized. Following histories of westward expansion that tied family security to the frontier, I explore how this extends into the present in Silicon Valley, as expectations of security and middle class norms quietly domesticates high-risk finance. By placing speculative finance and suburbia into the same analytic frame, this study demonstrates how inequality is reproduced not only through spectacular accumulation at the top, but through the routine work of maintaining home, family, and class position in the middle. 
