...
**“Silicon Suburbia: Venture Trajectories and Middle Class Materialities in Silicon Valley”**

Silicon Valley, once mythologized as a progressive hub of technological innovation, now underwrites the infrastructure of an increasingly authoritarian U.S. state and global regimes of finance that produce inequality. Grounded in fifteen months of fieldwork conducted in 2022 and 2023, this historical and ethnographic project argues that today’s consolidation of power is not a rupture from the Valley’s past, but an extension of its foundational commitments to growth and expansion. Shifting attention to the venture capital-backed system of speculative growth that organizes both corporate strategy and everyday practices across the industry, this project investigates how growth is socially and politically produced even as harms become increasingly visible. 
 
This work situates Silicon Valley within a broader story of the post-1970s financialization of the U.S. economy, as people gravitate towards venture-backed companies as one of the few remaining pathways for maintaining middle class lifestyles. Following feminist anthropologists who reject the separation of "the economic" from domestic and social life, I examine the suburban family practices of the tech workforce not as background context but as a key site where inequality is legitimized and value is produced. Following histories of westward expansion that tied family security to the frontier, I explore how this extends into the present in Silicon Valley, as expectations of security and middle class norms quietly domesticate high-risk finance. By placing speculative finance and suburbia into the same analytic frame, this study demonstrates how inequality is reproduced not only through spectacular accumulation at the top, but through the routine work of maintaining home, family, and class position in the middle. 

_Michelle Venetucci is an economic anthropologist with a focus on the political economy of new and emerging technologies in Silicon Valley. Before graduate school, she spent the 2010s working at Lyft and Github while watching her husband build two venture capital-backed tech startups. She holds a bachelor’s in anthropology and urban planning from the University of Washington, Seattle, and a MPhil in anthropology from Yale. She's currently a PhD candidate in the Yale anthropology department and a policy fellow at the Institution for Social and Policy Studies._
